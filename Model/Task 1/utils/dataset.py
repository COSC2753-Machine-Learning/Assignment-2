...
def load(from_dir: str) -> pd.DataFrame:
    ...
    for furniture_class in os.listdir(from_dir):
        for ImgPath in os.listdir(f'{from_dir}{furniture_class}'):
            with Image.open(f'{from_dir}{furniture_class}/{ImgPath}') as im:
                data_dict['ImgPath'].append(f'{furniture_class}/{ImgPath}')
                ...
                data_dict['Class'].append(furniture_class)
